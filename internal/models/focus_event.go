...
// FocusEvent represents a single focus tracking event
...
// AppSummary represents aggregated time spent on an application
...
// ReportPeriod defines the time range for reports
...
// Report represents a complete time tracking report
type Report struct {
